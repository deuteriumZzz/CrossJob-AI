...
_BLOCK_KEYWORDS = (
    ...
    "доступ ограничен",
    "access denied",
    # Cloudflare-интерстишл (himalayas.app, подтверждено вживую
    # 2026-09-06) — ни разу не проходил ни через один из капча-триггеров
    # выше, поэтому парсер тихо принимал пустую страницу-заглушку за 0
    # найденных вакансий. Фразы специфичны для самого интерстишла (Ray
    # ID/копирайт-строка Cloudflare), а не общее "cloudflare" — реальная
    # вакансия вполне может упоминать Cloudflare как технологию/
    # работодателя в описании.
    "ray id:",
    "checking your browser before accessing",
    "выполнение проверки безопасности",
    "проверка выполнена успешно. ожидание ответа",
)
