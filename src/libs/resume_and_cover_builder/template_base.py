"""
HTML-шаблоны секций резюме/письма, вставляемые в LLM-промпты как
«Template to Use» — так LLM возвращает HTML в предсказуемой
структуре, и это упрощает сборку итогового документа.
"""
...
<section id="cover-letter">
    ...
    <p>[Opening paragraph: Introduce yourself and state the position you are
applying for.]</p>
    <p>[Body paragraphs: Highlight your qualifications, experiences, and how
they align with the job requirements.]</p>
    <p>[Closing paragraph: Express your enthusiasm for the position and thank
the recipient for their consideration.]</p>
    <p>Sincerely,</p>
    <p>[Your Name]</p>
    <p>[Date]</p>
    </div>
...
the cover letter, without any explanations or additional text and also without
```html ```
"""
...
<section id="education">
    ...
    <div class="entry">
      ...
      <div class="entry-details">
          <span class="entry-title">[Degree] in [Field of Study] | Grade: [Your
Grade]</span>
...
<section id="work-experience">
    ...
    <div class="entry">
      ...
      <ul class="compact-list">
          <li>[Describe your responsibilities and achievements in this role]
</li>
          <li>[Describe any key projects or technologies you worked with]
</li>
...
<section id="side-projects">
    ...
    <div class="entry">
      <div class="entry-header">
          <span class="entry-name"><i class="fab fa-github"></i> <a
href="[Github Repo or Link]">[Project Name]</a></span>
      </div>
      <ul class="compact-list">
...
<section id="achievements">
    <h2>Achievements</h2>
    <ul class="compact-list">
      <li><strong>[Award or Recognition or Scholarship or Honor]:</strong>
[Describe]</li>
      <li><strong>[Award or Recognition or Scholarship or Honor]:</strong>
[Describe]</li>
      <li><strong>[Award or Recognition or Scholarship or Honor]:</strong>
