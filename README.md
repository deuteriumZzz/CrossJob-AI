...
| Раздел | Что там |
|---|---|
| **Главная** | «Готовность» (что не подключено), «Свои каналы» (карточки Telegram-парсера и отправки почты), «Что сделать сейчас» (черновики на отправку, новые ответы, интервью, контакты HR, площадки на паузе — по клику ведёт куда нужно), статистика, площадки |
...
| **Рассылка** | Рассылка (база → письма → отправка через Gmail + статистика и напоминания) · База компаний (всё собранное с источником, импорт своего файла) |
