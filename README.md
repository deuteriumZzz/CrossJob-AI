...
- **Структурные правила против "AI-письма"** — сверх текущих чёрных списков слов-шаблонов (добавлены в каждое письмо и ответ на вопросы анкеты) теперь есть ещё структурные проверки: эм-даш как соединитель, паттерны "не только X, но и Y", общие концовки, принудительные трёхсписки — рекомендованный LLM отвечает на эти подсказки и пишет более индивидуально.
