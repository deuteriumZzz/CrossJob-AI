...
if __name__ == "__main__":
    test_parse_role_page_job_ids_dedupes()
    test_wellfound_vacancy_to_job_maps_ld_json_fields()
    test_wellfound_vacancy_to_job_missing_ld_json_degrades_gracefully()
    test_slugify_normalizes_position()
